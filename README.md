...
```bash
git clone https://github.com/AjayRajNegi/micro-chat.git
cd micro-chat
```
...
```bash
pnpm --filter @micro-chat/common build
```
...
pnpm --filter @micro-chat/auth-service dev
pnpm --filter @micro-chat/user-service dev
